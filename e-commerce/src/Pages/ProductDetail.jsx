        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <button onClick={addToCart} className="flex-1 bg-black text-white py-3 rounded-lg font-semibold hover:bg-gray-800">
                {isInCart ? "View in Cart" : "Add to Cart"}
              </button>
              
              <button onClick={toggleWishlist} className="px-6 border border-gray-300 rounded-lg font-semibold hover:bg-gray-50 flex items-center gap-2">
